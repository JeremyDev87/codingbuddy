...
export const SKILL_KEYWORDS: SkillKeywordConfig[] = [
  ...
  // ============================================================================
  // LEGACY MODERNIZATION - Priority 20
  // Between tech-debt (19) and refactoring (21): action-oriented migration workflow
  // ============================================================================
  {
  ...
  // ============================================================================
  // PROMPT ENGINEERING - Priority 14
  // Same priority as agent-design: complementary codingbuddy-specific authoring skill
  // Agent-design focuses on JSON structure, prompt-engineering on prompt content
  // ============================================================================
  {
